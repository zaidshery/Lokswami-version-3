...
export default function NewsroomError({
  ...
  useEffect(() => {
    // Log unexpected dashboard errors for client monitoring
    console.error('Newsroom Dashboard error:', error);
  }, [error]);

  const copy = {
    en: {
      eyebrow: 'Newsroom Error',
      title: 'Unable to load newsroom dashboard',
      description:
        'A temporary issue prevented the dashboard from loading. You can try refreshing the view or proceed directly to the work queue.',
      retry: 'Try again',
      openQueue: 'Open Work Queue',
    },
    hi: {
      eyebrow: 'न्यूज़रूम त्रुटि',
      title: 'डैशबोर्ड लोड करने में समस्या हुई',
      description:
        'डैशबोर्ड लोड करते समय एक अस्थायी समस्या आई। आप पुनः प्रयास कर सकते हैं या सीधे वर्क क्यू पर जा सकते हैं।',
