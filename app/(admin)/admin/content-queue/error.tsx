...
export default function ContentQueueError({
  error,
  reset,
}: {
  ...
  const copy = {
    en: {
      eyebrow: 'Publishing Desk Error',
      title: 'Unable to load content queue',
      description:
        'A temporary issue prevented content queue items from loading. You can try refreshing or go to the general work queue.',
      retry: 'Try again',
      openQueue: 'Open Work Queue',
    },
    hi: {
      eyebrow: 'प्रकाशन डेस्क त्रुटि',
      title: 'कंटेंट कतार लोड करने में समस्या हुई',
      description:
        'कंटेंट कतार के आइटम लोड करते समय एक अस्थायी समस्या आई। आप पुनः प्रयास कर सकते हैं या मुख्य वर्क क्यू पर जा सकते हैं।',
