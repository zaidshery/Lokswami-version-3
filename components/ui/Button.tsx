...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  breaking:
    'bg-breaking text-white shadow-editorial hover:bg-red-700 active:bg-red-800 font-bold uppercase tracking-wider border border-transparent',
};

const SIZE_CLASSES: Record<ButtonSize, string> = {
  sm: 'min-h-[36px] px-3 py-1.5 text-xs rounded-editorial-sm gap-1.5 sm:min-h-[34px]',
  md: 'min-h-[44px] px-4 py-2 text-sm rounded-editorial-md gap-2 sm:min-h-[40px]',
  lg: 'min-h-[48px] px-6 py-2.5 text-base rounded-editorial-lg gap-2.5 sm:min-h-[44px]',
};
  ...
  (
    ...
    return (
      <button
        ...
        className={`editorial-focus-ring inline-flex items-center justify-center font-semibold transition-all duration-150 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 select-none ${
