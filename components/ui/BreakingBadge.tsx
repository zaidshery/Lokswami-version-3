...
export function BreakingBadge({
  ...
  return (
    <span
      role="status"
      aria-label={label}
      className={`inline-flex items-center gap-1.5 rounded-editorial-xs bg-breaking px-2 py-0.5 text-[11px] font-black uppercase tracking-normal text-white shadow-sm select-none ${className}`}
      {...props}
    >
      {pulse ? (
